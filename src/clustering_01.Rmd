...
if (!file.exists(here("processed", project, "clusters_SNN_k10-k80_01.RDS"))) {
  ...
  saveRDS(clusters_list,
          here("processed", project, "clusters_SNN_k10-k80_01.RDS"))
} else{
  clusters_list <-
    readRDS(here("processed", project, "clusters_SNN_k10-k80_01.RDS"))
}
