...
lipid <- c("Fdps", "Hmgcs1", "Abca5", "Sqle", "Scd2", "Idi1", "Hsd17b7", "Mvk", "Fdft1", "Cyp51", "Ncor2", "Me1",  "Clock", "Fads1", "Scd1", "Plpp3", "Abca2", "Asah2", "Gltp", "Gm2a", "Arsb",  "Stard10", "Pcyt2", "Slc44a1", "Gpd1", "Agpat4", "Mtmr2", "Plekha1", "Enpp6", "Mgll", "Mid1ip1", "Plin3", "Ptgds", "Txnrd1", "Hsd17b11", "Ppp1cc", "Hexa", "Fabp5", "Gpx4", "Chpt1", "Msmo1", "Elovl5", "Cyp2j6", "Srd5a1")
