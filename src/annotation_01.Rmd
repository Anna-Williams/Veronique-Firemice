...
```{r}
# compute markers
if(!file.exists(here("outs", project, "markers_k60_01.RDS"))){
  markers <- findMarkers(sce, groups = sce$cluster_k60, direction="up", lfc=1)
  saveRDS(markers, here("outs", project, "markers_k60_01.RDS"))
}else{
  markers <- readRDS(here("outs", project, "markers_k60_01.RDS"))
}
```
